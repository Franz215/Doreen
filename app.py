...
def plot_stock_k_chart(IMGUR_CLIENT_ID, stock='0050', date_from='2020-01-01'):
    ...
    try:
        ...
        if df is None or df.empty:
            print(f"未能獲取股票數據，可能是因股票代碼不正確或數據來源問題。")
            return None
        ...
        upload_image = im.upload_image(PATH, title=stock + " candlestick chart")
        print(f"圖片上傳成功: {upload_image.link}")
            ...
            columns=[
                CarouselColumn(
                        ...
                        actions=[
                            ...
                            URIAction(
                                label='粉絲團',
                                uri='https://liff.line.me/2006134062-kwEXZxg4'
                            )
                        ]
                    ),
                CarouselColumn(
